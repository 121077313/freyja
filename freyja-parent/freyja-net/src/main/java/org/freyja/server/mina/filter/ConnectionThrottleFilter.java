...
public class ConnectionThrottleFilter extends IoFilterAdapter {
	...
	private final static Logger LOGGER = LoggerFactory
			.getLogger(ConnectionThrottleFilter.class);
	 ...
	 *            最大缓存数量
	 */
	public ConnectionThrottleFilter(long allowedInterval, int maxSize) {
		this.allowedInterval = allowedInterval;

		clients = new ConcurrentLinkedHashMap.Builder<String, Long>()
				.maximumWeightedCapacity(maxSize).weigher(Weighers.singleton()).build();
	}
